...
// from the Sheet 14 row. Do NOT wrap a look lock here — catalog red/blue
// lives on the sheet (overlay_catalog_pen_sheet14). Empty cells throw.
  ...
  if (v === undefined || v === null || String(v).trim() === '') {
    throw new Error(
      'pick_pen_creation: empty sheet field ' +
        ...
        ' on ' +
        (creationId || '?') +
        '. Overlay catalog look onto Sheet 14 first.'
    );
  }
  return v;
}
