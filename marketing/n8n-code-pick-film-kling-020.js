...
// Workflow: film_i2v_kling (temporary FILM-020 lock)
// Mode: Run Once for All Items
// After: get_film_stills
// Before: prep_openrouter_i2v
//
// Picks FILM-020 only. Restore the shared next-empty-Kling pick after the run.

var REQUIRED_PROVIDER = 'kling';
var ALLOWED = { 'FILM-020': true };
...
if (!scored.length) throw new Error('No Active FILM-020 ' + REQUIRED_PROVIDER + ' row with picked_url and empty video_url.');
var pick = scored[0];
