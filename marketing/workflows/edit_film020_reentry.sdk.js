...
const howto = sticky({
  config: {
    ...
    parameters: {
      ...
      width: 860,
      height: 360,
      content: '# edit_film020_reentry (unpublished)\\n# FILM-020 only. Grok-edits the EXACT FILM-009 ship into atmospheric reentry.\\n# Does not touch FILM-001 or FILM-004. Run after overlay_film020_reentry. Do not Publish.',
    },
  },
});
...
const getFilm = node({
  ...
  config: {
    ...
    output: [{ still_id: 'FILM-020', still_edit_prompt: 'Keep this EXACT FILM-009 ship', model_still: 'grok-imagine-image-2.0', aspect_ratio: '9:16', n: '1', picked_url: 'https://raw.githubusercontent.com/PalmBeach-Vitality/store/cursor/film020-reentry-4c4b/marketing/stills/film009-ship.jpg' }],
  },
});
...
const grokEdit = node({
  ...
  config: {
    ...
    output: [{ data: [{ url: 'https://example.com/film020-reentry.png' }] }],
  },
});
...
const sheetsUpdate = node({
  ...
  config: {
    ...
    output: [{ still_id: 'FILM-020', take_urls: 'https://example.com/film020-reentry.png' }],
  },
});

export default workflow('edit_film020_reentry', 'edit_film020_reentry')
  .add(howto)
  .add(startTrigger)
  .to(getFilm)
  .to(prepEdits)
