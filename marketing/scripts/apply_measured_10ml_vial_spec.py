...
STILL_NEW = (
    ...
    "brushed-silver aluminum crimp 92 percent of body width, simple uniform bright blue "
    "plastic cap ONLY 94 percent of body width (smooth round one-piece disc, no tabs — "
    "FORBIDDEN: tabs, wings, pull-tabs, tear-tabs, side flaps, hanging pieces). "
