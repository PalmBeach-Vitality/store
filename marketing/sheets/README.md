...
| `8-lab-items-250.csv` | `8-lab-items-250` (250 real lab-item subject variables) |
| `9-lab-item-creations-250.csv` | `9-lab-item-creations-250` (**production** unique daily Imagine/video prompts) |
