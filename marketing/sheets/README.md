...
| `17-seedance-25-t2v.csv` | `17-seedance-25-t2v` (**new** Seedance 2.5 hyperrealistic T2V — 27 compounds from Sheet 15; prompt / model / duration / resolution / aspect / audio / bitrate / wait on the sheet; native max 30s) |
