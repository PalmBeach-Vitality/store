...
| `18-motsc-film-stills.csv` | `18-motsc-film-stills` (MOTS-C film stills + I2V stack — `video_provider` / `model_video` per beat: Seedance 2.5, Kling 3.0, Veo 3.1; Runway Gen-4.5 optional) |
