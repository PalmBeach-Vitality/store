...
| `9-lab-item-creations-500.csv` | `9-lab-item-creations-500` (**production** Grok still/video — 500 rows; includes `still_edit_prompt`, models, motion, writeback `still_url` + `video_url`; no Creatomate `mod_*`) |
