...
**Subjects (non-negotiable):** image/video variables may use **only** the **500 real lab items** in `sheets/8-lab-items-500.csv` / creations `sheets/9-lab-item-creations-500.csv`. No abstract orbs, surreal glass, CGI spheres, or non-lab fantasy props. See `n8n-lab-items-500.md`.

- 500 unique lab-item creations (`9-lab-item-creations-500`)
- each with unique `lab_item_id` / concrete `lab_item`
